                ...
                <div className="relative w-full rounded-[20px] bg-[#0c0c0c]/95 border border-[#FF7A00]/25 backdrop-blur-xl p-8 sm:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.5),0_0_30px_rgba(255,122,0,0.12)] space-y-6">
                    ...
                    <div className="text-center space-y-2">
                        ...
                        <p className="text-xs text-zinc-400 leading-relaxed max-w-[340px] mx-auto">
                            Setup your new login credentials below. Your password must be at least 8 characters long.
                        </p>
                    </div>
                    ...
                    {!token ? (
                        ...
                        <div className="space-y-6 animate-fade-in-scale">
                            <div className="rounded-[14px] bg-red-955/40 border border-red-500/20 p-4 text-center text-xs text-red-400 flex flex-col items-center justify-center gap-3">
                                <span className="w-2 h-2 rounded-full bg-red-500 animate-ping"></span>
                                <p className="font-medium">Invalid or missing reset token. Please request a new password reset link.</p>
                            </div>
                            <Link
                        ...
                        <div className="rounded-[14px] bg-emerald-950/40 border border-emerald-500/20 p-4 text-center text-xs text-emerald-400 flex flex-col items-center justify-center gap-3 animate-fade-in-scale">
                            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
                            <p className="font-semibold">Password reset successfully! Redirecting you to login...</p>
                        </div>
                    ) : (
                        /* Reset Password Form */
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="space-y-1.5">
                                <label className="text-xs font-medium uppercase tracking-wider text-zinc-400" htmlFor="new-password-input">
                                    New Password
                                </label>
                            ...
                            {/* Confirm Password */}
                            <div className="space-y-1.5">
                                <label className="text-xs font-medium uppercase tracking-wider text-zinc-400" htmlFor="confirm-password-input">
                                    Confirm Password
                                </label>
                                <div className="relative group">
                                    <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
