    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0A0A1A] via-[#1A1A2E] to-[#0A0A1A]">
      ...
      <div className="sticky top-0 z-50 backdrop-blur-xl bg-[#0A0A1A]/80 border-b border-[#2A2A4A]">
        <div className="flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-lg font-semibold text-white">New Service</h1>
              <p className="text-xs text-gray-400">Create a new service offering</p>
            </div>
          </div>
      ...
      <form id="service-form" onSubmit={handleSubmit} className="flex h-[calc(100vh-73px)]">
        ...
        <div className="w-[45%] overflow-y-auto p-6 space-y-6 pb-16">
          ...
          <div id="basic" className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
          ...
          {/* Card 2: Description */}
          <div id="description" className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6A00]/20 to-[#FF6A00]/5 flex items-center justify-center border border-[#FF6A00]/20 shadow-lg shadow-[#FF6A00]/10">
          ...
          {/* Card 3: Features */}
          <div id="features" className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6A00]/20 to-[#FF6A00]/5 flex items-center justify-center border border-[#FF6A00]/20 shadow-lg shadow-[#FF6A00]/10">
          ...
          {/* Card 4: Media */}
          <div id="media" className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6A00]/20 to-[#FF6A00]/5 flex items-center justify-center border border-[#FF6A00]/20 shadow-lg shadow-[#FF6A00]/10">
          ...
          <div id="display" className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6A00]/20 to-[#FF6A00]/5 flex items-center justify-center border border-[#FF6A00]/20 shadow-lg shadow-[#FF6A00]/10">
          ...
          {/* Card 6: SEO */}
          <div id="seo" className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6A00]/20 to-[#FF6A00]/5 flex items-center justify-center border border-[#FF6A00]/20 shadow-lg shadow-[#FF6A00]/10">
          ...
          {/* Card 7: CTA */}
          <div className="bg-[#1A1A2E]/60 backdrop-blur-xl border border-[#2A2A4A] rounded-2xl p-6 transition-all hover:border-[#FF6A00]/30 hover:shadow-xl hover:shadow-[#FF6A00]/5">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#FF6A00]/20 to-[#FF6A00]/5 flex items-center justify-center border border-[#FF6A00]/20 shadow-lg shadow-[#FF6A00]/10">
