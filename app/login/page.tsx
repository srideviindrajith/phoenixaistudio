                ...
                >
                    ...
                    {error && (
                        <div className="rounded-[14px] bg-red-955/40 border border-red-500/20 p-3 text-center text-xs text-red-400 flex items-center justify-center gap-2 animate-shake">
                            <span className="w-1.5 h-1.5 rounded-full bg-red-555"></span>
                            <span>{error}</span>
                        </div>
                    )}
                    ...
                    {/* Success Message */}
                    {successMessage && (
                        <div className="rounded-[14px] bg-emerald-955/40 border border-emerald-500/20 p-3 text-center text-xs text-emerald-400 flex items-center justify-center gap-2 animate-fade-in-scale">
